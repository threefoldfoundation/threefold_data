```js
!!person_define id:muhammed_azmy
	...
	image_path:muhamed_amzy.png
	memberships:['team']
	organizations:['threefold_tech']
	title:'Muhammed Azmy'

!!person_add_link id: muhammed_azmy label:LinkedIn
	url:'https://www.linkedin.com/in/muhamadazmy/'

!!person_add_link id: muhammed_azmy label:github
	url:'https://github.com/muhamadazmy'

!!person_add_link id: muhammed_azmy label:websites

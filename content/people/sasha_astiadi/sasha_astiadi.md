```js
!!person_define cid:'sasha_astiadi'
	...
	image_path:sasha_astiadi.png
	memberships:['team']
	organizations:['threefold_foundation', ' threefold_tech']

!!person_add_link cid: sasha_astiadi label:LinkedIn
	url:'https://www.linkedin.com/in/sastiadi'

!!person_add_link cid: sasha_astiadi label:github
	url:'https://github.com/sasha-astiadi'

!!person_add_link cid: sasha_astiadi label:websites
	url:'https://threefold.io/, https://threefold.tech, https://sashaastiadi.com/'
```
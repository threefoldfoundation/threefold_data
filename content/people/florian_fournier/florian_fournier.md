```js
!!person_define cid:'florian_fournier'
	...
	image_path:florian_fournier.jpeg
	memberships:['team']
	organizations:['ootopia', ' threefold_foundation']

!!person_add_link cid: florian_fournier label:LinkedIn
	url:'https://www.linkedin.com/in/florianfournier/'

!!person_add_link cid: florian_fournier label:websites

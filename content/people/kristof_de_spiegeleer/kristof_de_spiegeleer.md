```js
!!person_define cid:'kristof_de_spiegeleer'
	...
	image_path:kristof_de_spiegeleer.jpeg
	memberships:['team']
	organizations:['threefold_foundation', ' threefold_tech']

!!person_add_link cid: kristof_de_spiegeleer label:LinkedIn
	url:'https://www.linkedin.com/in/despiegk/'

!!person_add_link cid: kristof_de_spiegeleer label:github
	url:'https://github.com/despiegk'

!!person_add_link cid: kristof_de_spiegeleer label:websites
	url:'https://www.threefold.io, https://www.incubaid.com/'
```
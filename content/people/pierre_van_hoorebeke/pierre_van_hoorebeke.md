```js
!!person_define id:pierre_van_hoorebeke
	...
	image_path:pierre_van_hoorebeke.png
	memberships:['team']
	organizations:'['threefold_tech', ' threefold_foundation']'
	title:'Pierre van Hoorebeke'

!!person_add_link id: pierre_van_hoorebeke label:LinkedIn
	url:'https://www.linkedin.com/in/pierre-van-hoorebeke-5958343/'

!!person_add_link id: pierre_van_hoorebeke label:websites

```js
!!person_define cid:'erwan_renaut'
	...
	image_path:erwan_renaut.jpeg
	memberships:['team']
	organizations:['threefold_tech']

!!person_add_link cid: erwan_renaut label:LinkedIn
	url:'https://www.linkedin.com/in/erwan-renaut-78869433/'

!!person_add_link cid: erwan_renaut label:github
	url:'https://github.com/renauter'

!!person_add_link cid: erwan_renaut label:websites
	url:'https://www.threefold.tech'
```
```js
!!person_define id:alexandre_hannelas
	...
	image_path:alexandre_hannelas.jpeg
	memberships:['team']
	organizations:['threefold_foundation']
	title:'Alexandre Hannelas'

!!person_add_link id: alexandre_hannelas label:LinkedIn
	url:'https://www.linkedin.com/in/alexandre-hannelas-741681112/'

!!person_add_link id: alexandre_hannelas label:github
	url:'https://github.com/AlexandreHannelas'

!!person_add_link id: alexandre_hannelas label:websites

```js
!!person_define cid:'sameh_abouelsaad'
	...
	image_path:sameh_abouelsaad.jpg
	memberships:['team']
	organizations:['threefold_tech']

!!person_add_link cid: sameh_abouelsaad label:LinkedIn
	url:'https://www.linkedin.com/in/sameh-farouk-software-developer/'

!!person_add_link cid: sameh_abouelsaad label:github
	url:'https://github.com/sameh-farouk'

!!person_add_link cid: sameh_abouelsaad label:websites

```js
!!person_define cid:'mohamed_amer'
...
!!person_add_link cid: mohamed_amer label:LinkedIn
	url:'https://www.linkedin.com/in/mohamedamer45/'

!!person_add_link cid: mohamed_amer label:github
	url:'https://github.com/mohamedamer453'

!!person_add_link cid: mohamed_amer label:websites

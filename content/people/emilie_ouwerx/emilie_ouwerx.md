```js
!!person_define cid:'emilie_ouwerx'
	...
	image_path:emilie_ouwerx.jpeg
	memberships:['team']
	organizations:['threefold_foundation']

!!person_add_link cid: emilie_ouwerx label:LinkedIn
	url:'https://www.linkedin.com/in/emilieouwerx'

!!person_add_link cid: emilie_ouwerx label:github
	url:

!!person_add_link cid: emilie_ouwerx label:websites
	url:
```
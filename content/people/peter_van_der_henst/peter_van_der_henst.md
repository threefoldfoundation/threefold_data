```js
!!person_define id:peter_van_der_henst
	...
	image_path:peter_van_der_henst.png
	memberships:['team']
	organizations:['threefold_tech']
	title:'Peter van der Henst'

!!person_add_link id: peter_van_der_henst label:LinkedIn
	url:'https://www.linkedin.com/in/petervanderhenst/'

!!person_add_link id: peter_van_der_henst label:websites

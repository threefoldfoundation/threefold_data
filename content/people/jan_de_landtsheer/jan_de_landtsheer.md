```js
!!person_define cid:'jan_de_landtsheer'
	...
	image_path:jan_de_landtsheer.jpeg
	memberships:['team']
	organizations:['threefold_tech']

!!person_add_link cid: jan_de_landtsheer label:LinkedIn
	url:'https://www.linkedin.com/in/jand2/'

!!person_add_link cid: jan_de_landtsheer label:github
	url:'https://github.com/delandtj'

!!person_add_link cid: jan_de_landtsheer label:websites
